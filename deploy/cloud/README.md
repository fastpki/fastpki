...
CA keys into the standby's token (`high-availability.md` §3). It is not done at first boot
...
[`high-availability.md`](../../docs/high-availability.md) §7 has the detail, including why
