...
| [`docs/deployment.md`](docs/deployment.md) | **Installation:** Step-by-step install on Docker Compose, Kubernetes, Alpine + OpenRC and AWS, using the installer and the other scripts. Start here. |
...
| [`docs/manual-procedures.md`](docs/manual-procedures.md) | **Manual procedures:** What each installer and HA script does, step by step, for when you cannot run the script or need to finish a step it reported as failed. |
