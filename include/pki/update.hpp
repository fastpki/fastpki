...
// Verify against the public keys compiled into this build, which is what happens when
// RELEASE_PUBKEY names nothing. Either of the two signatures a release carries satisfies it.
