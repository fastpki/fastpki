...
identifies the MACHINE — to Postgres replication, and in `p11_transport` (`high-availability.md` §10).
...
**[code] The schema version is 3.** Version 1 is the baseline of v0.1.0 through v0.2.3;
`sql/steps/0002-acme-device-attestation.sql` takes a version 1 database to version 2, and
`sql/steps/0003-web-session-idle.sql` takes it to version 3.
